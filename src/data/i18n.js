...
export const T = {
  ca:{
    ...
    fed_title:"Federació",fed_subtitle:"Les teves partides oficials",fed_connect:"Connectar",fed_connect_title:"CONNECTA LA FEDERACIÓ",
    fed_connect_sub:"Porta tot el teu historial oficial a l'app",
    fed_benefit_1:"Tots els teus tornejos i voltes oficials en un sol lloc",fed_benefit_2:"Evolució del teu hàndicap exacte",fed_benefit_3:"Estadístiques que combinen partides oficials i amistoses",
    fed_licencia:"Llicència",fed_licencia_ph:"Ex: ACPP033065",fed_password:"Contrasenya de la federació",
    fed_consent:"Autoritzes Pitch & Clubs a accedir a pitch.cat en el teu nom per llegir els teus resultats. La contrasenya es guarda xifrada i només s'utilitza per a això. Pots desconnectar el compte i esborrar les dades quan vulguis.",
    fed_consent_check:"Ho entenc i ho autoritzo",fed_connect_btn:"Connectar i importar",fed_connecting:"Connectant amb la federació...",
    fed_importing:"Important les teves voltes...",fed_connected:"Connectat",fed_licence_label:"Llicència",
    fed_last_sync:"Última sincronització",fed_never_synced:"Encara sense sincronitzar",fed_sync_now:"Sincronitzar ara",fed_syncing:"Sincronitzant...",
    fed_disconnect:"Desconnectar",fed_disconnect_title:"Desconnectar la federació",
    fed_disconnect_desc:"Deixarem de sincronitzar i esborrarem la contrasenya guardada.",fed_delete_data:"Esborrar també les voltes importades",
    fed_disconnect_confirm:"Sí, desconnecta",fed_cancel:"Cancel·lar",
    fed_err_credentials:"Credencials incorrectes. Revisa la llicència i la contrasenya.",
    fed_err_unavailable:"La federació no respon ara mateix. Torna-ho a provar en una estona.",
    fed_err_generic:"No s'ha pogut completar l'operació. Torna-ho a provar.",
    fed_err_consent:"Has d'acceptar l'autorització per continuar.",fed_err_fields:"Omple la llicència i la contrasenya.",
    fed_auth_error:"No hem pogut accedir a la federació. Torna a introduir la contrasenya.",
    fed_reconnect:"Tornar a connectar",fed_rounds_imported:"{n} voltes oficials",fed_new_rounds:"{n} voltes noves importades",
    fed_up_to_date:"Tot al dia, sense voltes noves",fed_no_rounds:"No hem trobat partides oficials amb aquesta llicència",
    fed_not_connected_desc:"Ets federat? Connecta el teu compte i porta tot el teu historial oficial.",
    hist_title:"Historial",hist_all:"Totes",hist_official:"Oficials",hist_friendly:"Amistoses",
    hist_empty:"Encara no hi ha partides",badge_official:"Oficial",badge_friendly:"Amistosa",
  },
  es:{
    ...
    fed_title:"Federación",fed_subtitle:"Tus partidas oficiales",fed_connect:"Conectar",fed_connect_title:"CONECTA LA FEDERACIÓN",
    fed_connect_sub:"Trae todo tu historial oficial a la app",
    fed_benefit_1:"Todos tus torneos y vueltas oficiales en un solo sitio",fed_benefit_2:"Evolución de tu hándicap exacto",fed_benefit_3:"Estadísticas que combinan partidas oficiales y amistosas",
    fed_licencia:"Licencia",fed_licencia_ph:"Ej: ACPP033065",fed_password:"Contraseña de la federación",
    fed_consent:"Autorizas a Pitch & Clubs a acceder a pitch.cat en tu nombre para leer tus resultados. La contraseña se guarda cifrada y solo se usa para esto. Puedes desconectar la cuenta y borrar los datos cuando quieras.",
    fed_consent_check:"Lo entiendo y lo autorizo",fed_connect_btn:"Conectar e importar",fed_connecting:"Conectando con la federación...",
    fed_importing:"Importando tus vueltas...",fed_connected:"Conectado",fed_licence_label:"Licencia",
    fed_last_sync:"Última sincronización",fed_never_synced:"Todavía sin sincronizar",fed_sync_now:"Sincronizar ahora",fed_syncing:"Sincronizando...",
    fed_disconnect:"Desconectar",fed_disconnect_title:"Desconectar la federación",
    fed_disconnect_desc:"Dejaremos de sincronizar y borraremos la contraseña guardada.",fed_delete_data:"Borrar también las vueltas importadas",
    fed_disconnect_confirm:"Sí, desconecta",fed_cancel:"Cancelar",
    fed_err_credentials:"Credenciales incorrectas. Revisa la licencia y la contraseña.",
    fed_err_unavailable:"La federación no responde ahora mismo. Vuelve a intentarlo en un rato.",
    fed_err_generic:"No se ha podido completar la operación. Vuelve a intentarlo.",
    fed_err_consent:"Debes aceptar la autorización para continuar.",fed_err_fields:"Rellena la licencia y la contraseña.",
    fed_auth_error:"No hemos podido acceder a la federación. Vuelve a introducir la contraseña.",
    fed_reconnect:"Volver a conectar",fed_rounds_imported:"{n} vueltas oficiales",fed_new_rounds:"{n} vueltas nuevas importadas",
    fed_up_to_date:"Todo al día, sin vueltas nuevas",fed_no_rounds:"No hemos encontrado partidas oficiales con esta licencia",
    fed_not_connected_desc:"¿Eres federado? Conecta tu cuenta y trae todo tu historial oficial.",
    hist_title:"Historial",hist_all:"Todas",hist_official:"Oficiales",hist_friendly:"Amistosas",
    hist_empty:"Todavía no hay partidas",badge_official:"Oficial",badge_friendly:"Amistosa",
  },
  en:{
    ...
    fed_title:"Federation",fed_subtitle:"Your official rounds",fed_connect:"Connect",fed_connect_title:"CONNECT THE FEDERATION",
    fed_connect_sub:"Bring your full official history into the app",
    fed_benefit_1:"Every official tournament and round in one place",fed_benefit_2:"Track your exact handicap over time",fed_benefit_3:"Stats that combine official and friendly rounds",
    fed_licencia:"Licence",fed_licencia_ph:"e.g. ACPP033065",fed_password:"Federation password",
    fed_consent:"You authorise Pitch & Clubs to access pitch.cat on your behalf to read your results. Your password is stored encrypted and used only for this. You can disconnect and delete your data at any time.",
    fed_consent_check:"I understand and authorise this",fed_connect_btn:"Connect and import",fed_connecting:"Connecting to the federation...",
    fed_importing:"Importing your rounds...",fed_connected:"Connected",fed_licence_label:"Licence",
    fed_last_sync:"Last sync",fed_never_synced:"Not synced yet",fed_sync_now:"Sync now",fed_syncing:"Syncing...",
    fed_disconnect:"Disconnect",fed_disconnect_title:"Disconnect the federation",
    fed_disconnect_desc:"We will stop syncing and delete the stored password.",fed_delete_data:"Also delete imported rounds",
    fed_disconnect_confirm:"Yes, disconnect",fed_cancel:"Cancel",
    fed_err_credentials:"Wrong credentials. Check your licence and password.",
    fed_err_unavailable:"The federation is not responding right now. Try again in a while.",
    fed_err_generic:"Could not complete the operation. Please try again.",
    fed_err_consent:"You need to accept the authorisation to continue.",fed_err_fields:"Fill in your licence and password.",
    fed_auth_error:"We could not reach the federation. Please enter your password again.",
    fed_reconnect:"Reconnect",fed_rounds_imported:"{n} official rounds",fed_new_rounds:"{n} new rounds imported",
    fed_up_to_date:"All up to date, no new rounds",fed_no_rounds:"No official rounds found for this licence",
    fed_not_connected_desc:"Are you a federated player? Connect your account and bring your official history.",
    hist_title:"History",hist_all:"All",hist_official:"Official",hist_friendly:"Friendly",
    hist_empty:"No rounds yet",badge_official:"Official",badge_friendly:"Friendly",
  },
};
